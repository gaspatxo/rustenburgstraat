...
In vew of the next tuinmeester Gijs being experienced with student associations, we will ask him if he has done something similar to requesting budgets from the gemente. 

## Actions

- Zulal & Luka will find and obtain one picnic table
- Isabela & Jordi will propose a specific solution for communal storage (like gardening tools or foldable chairs)
